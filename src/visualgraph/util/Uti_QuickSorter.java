...
/**Uti_QuickSorter: nicht rekursive QuickSort-Implementierung*/
public class Uti_QuickSorter extends Object
{
    ...
    /**Sort: durchf�hren von Quicksort �ber SortAdapter*/
    public void Sort (Object [] list, Uti_SortAdapter tool, boolean descending)
    {
        ...
        if (descending)
            comp = Uti_SortAdapter.COMP_GRTR;
        else
            comp = Uti_SortAdapter.COMP_LESS;
